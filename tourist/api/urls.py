...
urlpatterns = [
 ...
 #  url(r'^editcategory/(?P<id>\d+)/$',CategoryUpdateAPIView.as_view(),name="updateCategory"),
 #  url(r'^deletecategory/(?P<id>\d+)/$',CategoryDeleteAPIView.as_view(),name="deleteCategory"),
  ...
  # url(r'^hotel/$',HotelListAPIView.as_view(),name="hotelList"),
